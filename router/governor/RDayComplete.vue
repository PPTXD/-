        ...
        <el-container>
          ...
          <el-main >
            <el-table :data="Applyday" >
              ...
              <el-table-column width="110">
                <template slot-scope="scope">
                  <i v-if="scope.row.bool >0" class="el-icon-check"></i>
                  <i v-if="scope.row.bool <1" class="el-icon-close"></i>
                </template>
              </el-table-column>
  ...
  import axios from 'axios';
    export default {
      ...
      methods:{
          getApplyday(){
            var that=this;
            axios.get('http://localhost:8888/user/applyday/complete').then(function (resp) {
